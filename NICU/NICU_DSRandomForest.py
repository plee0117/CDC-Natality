# -*- coding: utf-8 -*-
"""DownsampledRandomForest.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1H_AMCJYnIgpvOdV5uSqnTWlB4vjeTnbm
"""
...
cmfit = confusion_matrix(y_test, randomForest.predict(X_test))
cmfit

#RANDOM FOREST fit with class weight
randomForest1 = ensemble.RandomForestClassifier()
randomForest1.set_params(random_state=0, class_weight = "balanced")
randomForest1.fit(X_train, y_train) 
print("The training error is: %.5f" % (1 - randomForest1.score(X_train, y_train)))
print("The test     error is: %.5f" % (1 - randomForest1.score(X_test, y_test)))

#CONFUSION MATRIX BALANCED
cmnotbalanced = confusion_matrix(y_test, randomForest1.predict(X_test))
cmnotbalanced
...
# GRID SEARCH, added scoring = scoring (optional)
